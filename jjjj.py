...
def main():
    ...
    feature_desc = {
        ...
        'HLTHPLN1':  "건강 보험, HMO(선불 건강관리), Medicare, 인디언 보건 서비스 등 어떤 형태의 건강 보장 제도를 갖고 있는가? (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        'PERSDOC2':  "개인 주치의 또는 건강관리 제공자가 있다고 생각하는지 여부 (예: 1=Yesone, 2=Morethan, 3=No, -1=Unknown)",
        'MEDCOST':   "지난 12개월 동안 비용 문제로 의사의 진료를 받지 못한 적이 있는지 여부 (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        'CHECKUP1':  "마지막으로 정기 건강검진을 받은 시점은 언제인가? (예: 1=Within1Y, 2=Within2Y, 3=Within5Y, 4=Over5Y, 8=Never, -1=Unknown; BLANK=null)",
        'BPMEDS':    "현재 고혈압 약을 복용 중인지 여부 (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        'BLOODCHO':  "혈중 콜레스테롤 수치를 측정한 적이 있는가? (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        'CHOLCHK':   "마지막으로 혈중 콜레스테롤 수치를 측정한 시점은 언제인가? (예: 1=Within1Y, 2=Within2Y, 3=Within5Y, 4=Over5Y, 8=Never, -1=Unknown; BLANK=null)",
        'TOLDHI2':   "보건 전문가로부터 혈중 콜레스테롤 수치가 높다고 들은 적이 있는가? (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        'CVDINFR4':  "보건 전문가로부터 심근경색(심장마비)을 진단받은 적이 있는가? (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        'ASTHMA3':   "보건 전문가로부터 천식 진단을 받은 적이 있는가? (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        'ASTHNOW':   "현재 천식이 있는지 여부 (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        'CHCSCNCR':  "보건 전문가로부터 피부암(스킨 캔서) 진단을 받은 적이 있는가? (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        'CHCOCNCR':  "보건 전문가로부터 피부암을 제외한 다른 암을 진단받은 적이 있는가? (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        'CHCCOPD1':  "보건 전문가로부터 COPD, 폐기종, 기관지염 등 진단을 받은 적이 있는가? (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        'HAVARTH3':  "보건 전문가로부터 관절염 진단을 받은 적이 있는가? (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        'ADDEPEV2':  "보건 전문가로부터 우울 장애 진단을 받은 적이 있는가? (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        ...
        'VETERAN3':  "군 복무 여부 (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        ...
        'INTERNET':  "지난 30일 이내 인터넷 사용 여부 (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        'QLACTLM2':  "신체적/정신적/감정적 문제로 활동 제한 여부 (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        'USEEQUIP':  "지팡이/휠체어/특수장비 사용 필요 여부 (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        'DECIDE':    "집중/기억/의사결정 어려움 여부 (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        'DIFFWALK':  "걷기/계단 오르기 어려움 여부 (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        'DIFFDRES':  "옷 입기/목욕하기 어려움 여부 (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        'DIFFALON':  "병원 방문/쇼핑 등 혼자 볼일 보기 어려움 여부 (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        'SMOKE100':  "생애 동안 담배 100개비 이상 흡연 여부 (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        'STOPSMK2':  "지난 12개월 금연 시도 여부 (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        'LASTSMK2':  "마지막 흡연 시기 (예: 1=Within1M, 2=Within3M, 3=Within6M, 4=Within1Y, 5=Within10Y, 7=Y10plus, 8=Never, -1=Unknown, BLANK=null)",
        'USENOW3':   "현재 씹는 담배/스너프/스누스 사용 여부 (예: 1=Daily, 2=Some, 3=Never, -1=Unknown, BLANK=null)",
        'LMTJOIN3':  "현재 관절염/관절 증상으로 활동 제한 여부 (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        'ARTHDIS2':  "관절염/관절 증상이 취업/업무에 미치는 영향 여부 (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        'ARTHSOCL':  "지난 30일 관절염/관절 증상으로 쇼핑/영화/종교/사교 활동에 방해 정도 (예: 1=High, 2=Moderate, 3=No, -1=Unknown, BLANK=null)",
        'JOINPAIN':  "지난 30일 관절 통증 정도 (예: 0~10 숫자, -1=Unknown, BLANK=null)",
        'FLUSHOT6':  "지난 12개월 독감 예방접종 여부 (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        'PNEUVAC3':  "폐렴 백신 접종 여부 (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        'HIVTST6':   "HIV 검사 받은 적 여부 (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        ...
        'PDIABTST':  "지난 3년 내 고혈당/당뇨병 검사 여부 (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        'PREDIAB1':  "당뇨 전단계 진단 여부 (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        'INSULIN':   "현재 인슐린 사용 여부 (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        'BLDSUGAR':  "혈당 확인 빈도 (예: 월간횟수, -1=Unknown, 0=Zero, BLANK=null)",
        'FEETCHK2':  "발 상태 확인 빈도 (예: 월간횟수, -1=Unknown, 0=Zero, BLANK=null)",
        'DOCTDIAB':  "지난 12개월 당뇨병 진료 횟수 (예: 1~76 직접 입력, 0=Zero, -1=Unknown, BLANK=null)",
        'CHKHEMO3':  "수최근 12개월당화혈색소(A1C) 검사 횟수 (예: 1~76 직접 입력, 0=한 번도 없음, -1=Unknown, BLANK=null)",
        'FEETCHK':   "지난 12개월 발 검사 횟수 (예: 1~76 직접 입력, 0=Zero, -1=Unknown, BLANK=null)",
        'DIABEYE':   "당뇨 합병증(망막병증) 여부 (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        'CIMEMLOS':  "지난 12개월 기억력 저하/혼란 여부 (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        ...
        '_RACEG21':  "비히스패닉 백인 여부 (예: 1=Yes, 2=No, -1=Unknown, BLANK=null)",
        ...
        'BPHIGH4':   "고혈압 진단 여부 (예: BLANK=null, 1=Yes, 3=No, -1=Unknown)",
        'CVDCRHD4':  "관상동맥 심장병 진단 여부 (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        'CVDSTRK3':  "뇌졸중 진단 여부 (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        'CHCKIDNY':  "신장 질환 진단 여부 (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        'DIABETE3':  "당뇨병 진단 여부 (예: BLANK=null, 1=Yes, 3=No, -1=Unknown)",
        ...
        'EXERANY2':  "지난 30일 운동 여부 (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        'STRENGTH':  "근력운동 횟수 (예: 월간횟수, -1=Unknown, 0=Zero, BLANK=null)",
        '_RFHYPE5':  "고혈압 진단 여부 (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        '_MICHD':    "관상동맥 심장병(CHD) 또는 심근경색(MI) 여부 (예: BLANK=null, 1=Yes, 2=No)",
        'HTM4':      "키(미터) (예: 91–244, BLANK=null)",
        'WTKG3':     "몸무게(kg) (예: 30–200, -1=Unknown)",
        '_BMI5':     "체질량지수(BMI) (예: 18.5–40)",
        '_SMOKER3':  "현재 흡연 여부 (예: 1='Daily', 2='Some', 3='Former', 4='Never', -1='Unknown')",
        'DRNKANY5':  "최근 30일간 음주 여부 (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        'DROCDY3_':  "최근 일주일간 평균 음주량 (예: 정수(3,7,10,71)=하루 평균 잔 수, -1=Unknown, BLANK=null)",
        '_FRUITEX':  "과일 섭취 여부 (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
        '_VEGETEX':  "채소 섭취 여부 (예: BLANK=null, 1=Yes, 2=No, -1=Unknown)",
