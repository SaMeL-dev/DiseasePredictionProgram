...
def main():
    ...
    feature_desc = {
        ...
        'CHECKUP1':  "마지막으로 정기 건강검진을 받은 시점 (예: 1=1년 이내, 2=2년 이내, 3=5년 이내, 4=5년 이상 8=없음, -1=Unknown)",
        'BPMEDS':    "현재 고혈압 약을 복용 중인지 여부 (예: 1=Yes, 2=No, -1=Unknown)",
        'BLOODCHO':  "혈중 콜레스테롤 수치를 측정한 적이 있는가? (예: 1=Yes, 2=No, -1=Unknown)", 
        'CHOLCHK':   "마지막으로 혈중 콜레스테롤 수치를 측정한 시점은 언제인가? (예: 1=1년 이내, 2=2년 이내, 3=5년 이내, 4=5년, 8=없음, -1=Unknown)",
        ...
        'HIVTSTD3':  "마지막 HIV 검사 시기 (월/년, 예: 2015년 5월=052015, -1=Unknown)",
        ...
        'BLDSUGAR':  "혈당 확인 빈도 (예: 월간횟수, -1=Unknown, 0=Zero)",
        'FEETCHK2':  "발 상태 확인 빈도 (예: 월간횟수, -1=Unknown, 0=Zero)",
        ...
        'FC60_':     "기능적 수행 능력 추정치 (예: 0–8590 = 소수점 2자리 포함 값(8590=85.90 라고 생각하면됨, -1=Unknown)",
        ...
        'ACTIN11_':  "첫 번째 활동 운동 강도 (예: 0=낮음, 1=중간, 2=높음)",
        'ACTIN21_':  "두 번째 활동 운동 강도 (예: 0=낮음, 1=중간, 2=높음)",
        ...
        'BPHIGH4':   "고혈압 진단 여부 (예: 1=Yes, 3=No, -1=Unknown)",
        'CVDCRHD4':  "관상동맥 심장병 진단 여부 (예: 1=Yes, 2=No, -1=Unknown)",
        'CVDSTRK3':  "뇌졸중 진단 여부 (예: 1=Yes, 2=No, -1=Unknown)",
        'CHCKIDNY':  "신장 질환 진단 여부 (예:1=Yes, 2=No, -1=Unknown)",
        'DIABETE3':  "당뇨병 진단 여부 (예: 1=Yes, 3=No, -1=Unknown)",
        ...
        'AVEDRNK2':  "지난 30일 평균 일 음주량 (예: 1–7=잔 수, -1=Unknown, 'ALCDAY5'에서 0입력=엔터키)",
        ...
        '_FRUITEX':  "과일 섭취 여부 (예: 1=Yes, 2=No, -1=Unknown)",
        '_VEGETEX':  "채소 섭취 여부 (예: 1=Yes, 2=No, -1=Unknown)",
